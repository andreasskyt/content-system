/**
 * Call Clip — big bold white Poppins for clipped call recordings (Zoom/Meet
 * screen-share + camera tiles). Same plain look as `youtube` but scaled up
 * for feed viewing and anchored lower, with a soft halo so white text
 * survives bright screen-share regions.
 */
...
const style: EditStyle = {
  meta: {
    name: "CallClip",
    description:
      "Big bold white Poppins subtitles for call-recording clips, bottom-anchored, cumulative build, soft black halo.",
  },
  ...
  subs: {
    ...
    vertical_position_pct_from_top: 84,
    max_width_pct: 90,
